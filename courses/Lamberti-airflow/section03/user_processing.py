...
with DAG(
    ...
    creating_table = SqliteOperator(
        task_id="creating_table", sqlite_conn_id="db_sqlite", sql=_sql_command
    )
    ...
    # extract users
    _response_lambda = lambda response: json.loads(response.text)  # noqa: E731
    ...
    """
    storing_user = BashOperator(task_id="storing_user", bash_command=_bash_command)
